/* cheese-window.c generated by valac 0.32.0.53-28fa, the Vala compiler
				...
				file = _tmp19_;
				{
					...
					__catch5_g_error:
					{
						...
						if (!_tmp24_) {
							...
							_tmp25_ = _ ("Could not delete %s");
							_tmp26_ = file;
							_tmp27_ = g_file_get_path (_tmp26_);
							_tmp28_ = _tmp27_;
							_tmp29_ = (GtkMessageDialog*) gtk_message_dialog_new ((GtkWindow*) self, GTK_DIALOG_MODAL | GTK_DIALOG_DESTROY_WITH_PARENT, GTK_MESSAGE_ERROR, GTK_BUTTONS_NONE, _tmp25_, _tmp28_);
							g_object_ref_sink (_tmp29_);
							_tmp30_ = _tmp29_;
							_g_free0 (_tmp28_);
							error_dialog = _tmp30_;
							_tmp31_ = error_dialog;
							_tmp32_ = _ ("_Cancel");
							gtk_dialog_add_button ((GtkDialog*) _tmp31_, _tmp32_, (gint) GTK_RESPONSE_CANCEL);
							_tmp33_ = error_dialog;
							_tmp34_ = _ ("Skip");
							gtk_dialog_add_button ((GtkDialog*) _tmp33_, _tmp34_, (gint) CHEESE_MAIN_WINDOW_DELETE_RESPONSE_SKIP);
							_tmp35_ = error_dialog;
							_tmp36_ = _ ("Skip all");
							gtk_dialog_add_button ((GtkDialog*) _tmp35_, _tmp36_, (gint) CHEESE_MAIN_WINDOW_DELETE_RESPONSE_SKIP_ALL);
							_tmp37_ = error_dialog;
							_tmp38_ = gtk_dialog_run ((GtkDialog*) _tmp37_);
							error_response = _tmp38_;
							_tmp39_ = error_response;
							if (_tmp39_ == ((gint) CHEESE_MAIN_WINDOW_DELETE_RESPONSE_SKIP_ALL)) {
								skip_all_errors = TRUE;
							} else {
								gint _tmp40_ = 0;
								_tmp40_ = error_response;
								if (_tmp40_ == ((gint) GTK_RESPONSE_CANCEL)) {
									_g_object_unref0 (error_dialog);
									_g_error_free0 (err);
									_g_object_unref0 (file);
									break;
			...
			effect = _tmp24_;
			{
				...
				if (_tmp26_ == ((guint) _tmp27_)) {
					...
					if (!_tmp29_) {
						...
						_tmp32_ = _g_object_ref0 ((ClutterActor*) _tmp31_);
						texture = _tmp32_;
...
static void cheese_main_window_setup_effects_selector (CheeseMainWindow* self) {
	...
	if (_tmp0_ == NULL) {
		...
		_tmp18_ = _tmp17_->effects;
		{
			...
			for (effect_it = effect_collection; effect_it != NULL; effect_it = effect_it->next) {
				...
				effect = _tmp19_;
				{
					...
					ClutterText* _tmp64_ = NULL;
					ClutterText* _tmp65_ = NULL;
					ClutterActor* _tmp66_ = NULL;
					ClutterText* _tmp67_ = NULL;
					ClutterGridLayout* grid_layout = NULL;
					GList* _tmp68_ = NULL;
					guint _tmp69_ = 0U;
					gconstpointer _tmp70_ = NULL;
					ClutterLayoutManager* _tmp71_ = NULL;
					ClutterLayoutManager* _tmp72_ = NULL;
					ClutterGridLayout* _tmp73_ = NULL;
					ClutterGridLayout* _tmp74_ = NULL;
					...
					_tmp30_ = texture;
					clutter_actor_set_content_gravity (_tmp30_, CLUTTER_CONTENT_GRAVITY_RESIZE_ASPECT);
					_tmp31_ = box;
					_tmp32_ = texture;
					...
					_tmp34_ = box;
					g_object_set (_tmp34_, "min-height", (gfloat) 40, NULL);
					_tmp35_ = box;
					g_object_set (_tmp35_, "min-width", (gfloat) 50, NULL);
					_tmp36_ = (ClutterTapAction*) clutter_tap_action_new ();
					...
					_tmp39_ = tap;
					g_signal_connect_object (_tmp39_, "tap", (GCallback) _cheese_main_window_on_selected_effect_change_clutter_tap_action_tap, self, 0);
					_tmp40_ = box;
					_tmp41_ = effect;
					_tmp42_ = _g_object_ref0 (_tmp41_);
					g_object_set_data_full ((GObject*) _tmp40_, "effect", _tmp42_, g_object_unref);
					_tmp43_ = effect;
					_tmp44_ = texture;
					_tmp45_ = _g_object_ref0 (_tmp44_);
					g_object_set_data_full ((GObject*) _tmp43_, "texture", _tmp45_, g_object_unref);
					_tmp46_ = text;
					_tmp47_ = effect;
					_tmp48_ = cheese_effect_get_name (_tmp47_);
					_tmp49_ = _tmp48_;
					clutter_text_set_text (_tmp46_, _tmp49_);
					_tmp50_ = text;
					clutter_color_from_string (&_tmp51_, "white");
					clutter_text_set_color (_tmp50_, &_tmp51_);
					_tmp52_ = rect;
					_tmp53_ = text;
					_tmp54_ = clutter_actor_get_height ((ClutterActor*) _tmp53_);
					_tmp55_ = _tmp54_;
					clutter_actor_set_height (_tmp52_, _tmp55_ + 5);
					_tmp56_ = rect;
					clutter_actor_set_x_align (_tmp56_, CLUTTER_ACTOR_ALIGN_FILL);
					_tmp57_ = rect;
					clutter_actor_set_y_align (_tmp57_, CLUTTER_ACTOR_ALIGN_END);
					_tmp58_ = rect;
					clutter_actor_set_x_expand (_tmp58_, TRUE);
					_tmp59_ = rect;
					clutter_actor_set_y_expand (_tmp59_, TRUE);
					_tmp60_ = box;
					_tmp61_ = rect;
					clutter_actor_add_child (_tmp60_, _tmp61_);
					_tmp62_ = text;
					clutter_actor_set_x_align ((ClutterActor*) _tmp62_, CLUTTER_ACTOR_ALIGN_CENTER);
					_tmp63_ = text;
					clutter_actor_set_y_align ((ClutterActor*) _tmp63_, CLUTTER_ACTOR_ALIGN_END);
					_tmp64_ = text;
					clutter_actor_set_x_expand ((ClutterActor*) _tmp64_, TRUE);
					_tmp65_ = text;
					clutter_actor_set_y_expand ((ClutterActor*) _tmp65_, TRUE);
					_tmp66_ = box;
					_tmp67_ = text;
					clutter_actor_add_child (_tmp66_, (ClutterActor*) _tmp67_);
					_tmp68_ = self->priv->effects_grids;
					_tmp69_ = i;
					_tmp70_ = g_list_nth_data (_tmp68_, _tmp69_ / EFFECTS_PER_PAGE);
					_tmp71_ = clutter_actor_get_layout_manager ((ClutterActor*) _tmp70_);
					_tmp72_ = _tmp71_;
					_tmp73_ = _g_object_ref0 (G_TYPE_CHECK_INSTANCE_TYPE (_tmp72_, clutter_grid_layout_get_type ()) ? ((ClutterGridLayout*) _tmp72_) : NULL);
					grid_layout = _tmp73_;
					_tmp74_ = grid_layout;
					_tmp75_ = box;
					_tmp76_ = i;
					_tmp77_ = i;
					clutter_grid_layout_attach (_tmp74_, _tmp75_, ((gint) (_tmp76_ % EFFECTS_PER_PAGE)) % 3, ((gint) (_tmp77_ % EFFECTS_PER_PAGE)) / 3, 1, 1);
					_tmp78_ = i;
					i = _tmp78_ + 1;
					_g_object_unref0 (grid_layout);
		...
		_tmp80_ = g_list_nth_data (_tmp79_, (guint) 0);
		_tmp81_ = _g_object_ref0 ((ClutterActor*) _tmp80_);
		_g_object_unref0 (self->priv->current_effects_grid);
		self->priv->current_effects_grid = _tmp81_;
	}
}
...
void cheese_main_window_setup_ui (CheeseMainWindow* self) {
	...
	ClutterBinLayout* _tmp39_ = NULL;
	ClutterStage* _tmp40_ = NULL;
	ClutterActor* _tmp41_ = NULL;
	ClutterStage* _tmp42_ = NULL;
	ClutterText* _tmp43_ = NULL;
	ClutterStage* _tmp44_ = NULL;
	CheeseThumbView* _tmp45_ = NULL;
	CheeseThumbView* _tmp46_ = NULL;
	EogThumbNav* _tmp47_ = NULL;
	GtkMenu* _tmp48_ = NULL;
	CheeseThumbView* _tmp49_ = NULL;
	CheeseThumbView* _tmp50_ = NULL;
	GtkCssProvider* css = NULL;
	GdkScreen* _tmp54_ = NULL;
	GdkScreen* _tmp55_ = NULL;
	CheeseThumbView* _tmp56_ = NULL;
